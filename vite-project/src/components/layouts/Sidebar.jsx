...
//           position: "fixed",
//           left: 0,
//           top: "60px",   // 👈 sasa sidebar inaanzia chini ya header
//           bottom: 0,
//           zIndex: 999,
//           transition: "transform 0.3s ease",
//           boxShadow: "2px 0 5px rgba(0,0,0,0.1)"
...
//   className={`sidebar ${isOpen ? 'open' : ''}`}
//   style={{
//     width: "320px",   // 👈 imeongezwa kutoka 280px
//     background: "#1CA3DE",
//     color: "#fff",
//     display: "flex",
//     flexDirection: "column",
...
//             }} 
//           />
//           <h2 style={{ color: "#fff", margin: 0, fontSize: "1rem" }}>Research Management System</h2>
//         </div>
