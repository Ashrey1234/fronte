...
//     title: '',
//     category: '',
//     research_type: 'Environment & Marine',  // ✅ keep research_type
...
//                       {/* ✅ use file_path to extract filename */}
...
//     setLoading(true);
//     fetch(`${API_BASE_URL}/api/applications/${id}/`, { headers: getAuthHeaders() })
//       .then(res => { if (!res.ok) throw new Error('Failed to fetch application'); return res.json(); })
//       .then(data => {
//         setApplication(data);
//         setApplicationId(id);
...
//     const existingTypes = attachments.map(a => a.file_type);
//     const missingTypes = requiredTypes.filter(type => !existingTypes.includes(type));
//     if (missingTypes.length > 0) return setMessage({ text: `Missing attachments: ${missingTypes.join(', ')}`, severity: 'warning' });

//     setSubmitting(true);
//     fetch(`${API_BASE_URL}/api/applications/${applicationId}/submit/`, { method: 'POST', headers: getAuthHeaders() })
...
//               <Typography variant="h5" gutterBottom>Application Details</Typography>
//               <Grid container spacing={3}>
//                 <Grid item xs={12}><TextField fullWidth required label="Research Title" name="title" value={application.title} onChange={handleApplicationChange} className="small-field" /></Grid>
//                 <Grid item xs={12} sm={6}><TextField fullWidth required label="Category" name="category" value={application.category} onChange={handleApplicationChange} className="small-field" /></Grid>
//                 <Grid item xs={12} sm={6}>
//                   <TextField fullWidth required select label="Research Type" name="research_type" value={application.research_type} onChange={handleApplicationChange} className="small-field">
//                     <MenuItem value="Environment & Marine">Environment & Marine</MenuItem>
//                     <MenuItem value="Aquatic Organisms">Aquatic Organisms</MenuItem>
//                     <MenuItem value="Fisheries Research">Fisheries Research</MenuItem>
//                   </TextField>
//                 </Grid>
//                 <Grid item xs={12} sm={6}><TextField fullWidth required type="number" label="Year" name="year" value={application.year} onChange={handleApplicationChange} className="small-field" inputProps={{ min: 2000, max: new Date().getFullYear() + 5 }} /></Grid>
//                 <Grid item xs={12} sm={6}><TextField fullWidth required type="date" label="Start Date" name="start_date" value={application.start_date} onChange={handleApplicationChange} InputLabelProps={{ shrink: true }} className="small-field" /></Grid>
//                 <Grid item xs={12} sm={6}><TextField fullWidth required type="date" label="End Date" name="end_date" value={application.end_date} onChange={handleApplicationChange} InputLabelProps={{ shrink: true }} className="small-field" /></Grid>

//                 {/* Large textareas */}
//                 <Grid item xs={12}><TextField fullWidth required multiline label="Research Description" name="description" value={application.description} onChange={handleApplicationChange} className="large-field" /></Grid>
//                 <Grid item xs={12}><TextField fullWidth required multiline label="Objectives" name="objectives" value={application.objectives} onChange={handleApplicationChange} className="large-field" /></Grid>
//                 <Grid item xs={12}><TextField fullWidth required multiline label="Methodology" name="methodology" value={application.methodology} onChange={handleApplicationChange} className="large-field" /></Grid>
//                 <Grid item xs={12}><TextField fullWidth required multiline label="Expected Outcomes" name="expected_outcomes" value={application.expected_outcomes} onChange={handleApplicationChange} className="large-field" /></Grid>
//               </Grid>

//               <Box sx={{ display: 'flex', justifyContent: 'flex-end', mt: 3 }}>
//                 <Button fullWidth variant="contained" startIcon={<SaveIcon />} onClick={saveDraft} disabled={saving}>
//                   {saving ? <CircularProgress size={24} /> : 'Save & Continue'}
//                 </Button>
//               </Box>
//             </Box>
...
//                 <Grid item xs={12} sm={6}><TextField fullWidth label="Research Title" name="title" value={application.title} onChange={handleApplicationChange} /></Grid>
//                 <Grid item xs={12} sm={6}><TextField fullWidth label="Category" name="category" value={application.category} onChange={handleApplicationChange} /></Grid>
...
//                 <Grid item xs={12} sm={6}><TextField fullWidth type="date" label="Start Date" name="start_date" value={application.start_date} onChange={handleApplicationChange} InputLabelProps={{ shrink: true }} /></Grid>
//                 <Grid item xs={12} sm={6}><TextField fullWidth type="date" label="End Date" name="end_date" value={application.end_date} onChange={handleApplicationChange} InputLabelProps={{ shrink: true }} /></Grid>

//                 {/* Line 4-7: Large text areas */}
//                 <Grid item xs={12}><TextField fullWidth multiline rows={6} label="Research Description" name="description" value={application.description} onChange={handleApplicationChange} className="large-field" /></Grid>
//                 <Grid item xs={12}><TextField fullWidth multiline rows={5} label="Objectives" name="objectives" value={application.objectives} onChange={handleApplicationChange} className="large-field" /></Grid>
//                 <Grid item xs={12}><TextField fullWidth multiline rows={5} label="Methodology" name="methodology" value={application.methodology} onChange={handleApplicationChange} className="large-field" /></Grid>
//                 <Grid item xs={12}><TextField fullWidth multiline rows={5} label="Expected Outcomes" name="expected_outcomes" value={application.expected_outcomes} onChange={handleApplicationChange} className="large-field" /></Grid>
//               </Grid>
...
//                 {/* Line 5 */}
//                 <Grid item xs={12}>
//                   <TextField fullWidth multiline minRows={5} label="Objectives" name="objectives" value={application.objectives} onChange={handleApplicationChange} className="large-field" />
//                 </Grid>

//                 {/* Line 6 */}
//                 <Grid item xs={12}>
//                   <TextField fullWidth multiline minRows={5} label="Methodology" name="methodology" value={application.methodology} onChange={handleApplicationChange} className="large-field" />
//                 </Grid>

//                 {/* Line 7 */}
//                 <Grid item xs={12}>
//                   <TextField fullWidth multiline minRows={5} label="Expected Outcomes" name="expected_outcomes" value={application.expected_outcomes} onChange={handleApplicationChange} className="large-field" />
//                 </Grid>
//               </Grid>
